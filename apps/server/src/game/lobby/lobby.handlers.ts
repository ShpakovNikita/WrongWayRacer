...
import {CreateUserPayload, LobbyEventType, CallbackStatus, StartWrongWayRacerPayload, UserProfile} from "@splash/types";
...
const createWrongWayRacerArena = (io: Server, socket: Socket, database: GameDatabase, config: WrongWayRacerGameLogicConfig): WrongWayRacerArena => {
...
const removeWrongWayRacerArena = (database: GameDatabase, arena: WrongWayRacerArena, users: UserProfile[]) => {
